...
export default class Faq extends React.Component {
  render() {
    return (
	    ...
	    <h2>1. Can foreigners without green cards buy real estate in the United States?</h2>
	    ...
	    <h2>2. Why buy a house in the United States?</h2>
	    ...
	    <h2>3. Do I need to pay a service charge?</h2>
	    <p>North America purchase network does not charge any fees to buyers, all services (except VIP) are free.</p>

	    <h2>4. Can I immigrate to the United States after I buy a house in the United States?</h2>
	    ...
	    <h2>5. Is it the best time to invest in the US housing market?</h2>
